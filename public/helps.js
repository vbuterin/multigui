var help = {
    ...
    brainwallet: 'Generates a private key from your username and password, which you can then use to store and send bitcoins as long as you can remember what the username and password are. The key is generated by running a hash algorithm (plain SHA256 or thousand-round SHA256) with <code>hash(username + ":" + password)</code>.',
    slowsha: 'The precise algorithm specification is:<br><br><pre>showsha = function(x) {\n    var oldhash = x, newhash;\n    for (var i = 0; i < 1000; i++) {\n        newhash = sha256(oldhash);\n        oldhash = newhash+x;\n    }\n    return newhash;\n}</pre>'
}
